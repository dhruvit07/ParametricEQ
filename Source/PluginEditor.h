...
struct PathProducer
{
    PathProducer(SingleChannelSampleFifo<ParametricEQAudioProcessor::BlockType>& scsf) :
...
private:
    SingleChannelSampleFifo<ParametricEQAudioProcessor::BlockType>* leftChannelFifo;
